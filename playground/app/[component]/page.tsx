...
const normalData = [
  52.3, 48.7, 51.2, 49.8, 53.6, 47.4, 50.9, 52.1, 48.3, 51.7, 49.2, 52.8, 48.9, 50.4, 53.2,
  47.8, 51.5, 49.6, 52.6, 48.1, 50.7, 53.9, 47.2, 51.3, 49.9, 52.4, 48.5, 50.2, 53.5, 47.6,
  51.8, 49.4, 52.9, 48.8, 50.6, 53.1, 47.9, 51.4, 49.7, 52.7, 48.2, 50.8, 53.8, 47.3, 51.1,
  49.5, 52.5, 48.6, 50.3, 53.4, 47.7, 51.9, 49.3, 52.2, 48.4, 50.5, 53.3, 47.5, 51.6, 49.8,
  45.2, 54.8, 46.7, 55.3, 44.9, 56.1, 45.8, 54.2, 46.3, 55.7, 44.5, 56.5, 45.6, 54.4, 46.1,
  55.9, 44.7, 56.3, 45.4, 54.6, 46.5, 55.1, 44.3, 56.7, 45.9, 54.1, 46.8, 55.4, 44.6, 56.4,
  43.8, 57.2, 42.9, 58.1, 43.5, 57.5, 42.6, 58.4, 43.2, 57.8, 42.3, 58.7, 43.9, 57.1, 42.7,
  58.3, 43.4, 57.6, 42.8, 58.2, 43.1, 57.9, 42.4, 58.6, 43.6, 57.4, 42.5, 58.5, 43.3, 57.7,
  41.2, 59.8, 40.5, 60.5, 41.7, 59.3, 40.8, 60.2, 41.4, 59.6, 40.2, 60.8, 41.9, 59.1, 40.6,
  60.4, 41.3, 59.7, 40.9, 60.1, 41.6, 59.4, 40.3, 60.7, 41.8, 59.2, 40.7, 60.3, 41.1, 59.9,
  38.5, 62.5, 37.8, 63.2, 38.9, 62.1, 37.4, 63.6, 38.3, 62.7, 37.9, 63.1, 38.7, 62.3, 37.5,
  63.5, 38.4, 62.6, 37.6, 63.4, 38.8, 62.2, 37.2, 63.8, 38.6, 62.4, 37.7, 63.3, 38.2, 62.8,
  35.4, 65.6, 34.8, 66.2, 35.9, 65.1, 34.3, 66.7, 35.5, 65.5, 34.7, 66.3, 35.8, 65.2, 34.4,
  66.6, 35.6, 65.4, 34.6, 66.4, 35.7, 65.3, 34.2, 66.8, 35.3, 65.7, 34.9, 66.1, 35.2, 65.8,
  32.1, 68.9, 31.5, 69.5, 32.6, 68.4, 31.2, 69.8, 32.3, 68.7, 31.8, 69.2, 32.5, 68.5, 31.4,
  69.6, 32.4, 68.6, 31.6, 69.4, 32.7, 68.3, 31.1, 69.9, 32.2, 68.8, 31.9, 69.1, 32.8, 68.2,
  28.5, 72.5, 27.8, 73.2, 28.9, 72.1, 27.4, 73.6, 28.3, 72.7, 27.9, 73.1, 28.7, 72.3, 27.5,
  73.5, 28.4, 72.6, 27.6, 73.4, 28.8, 72.2, 27.2, 73.8, 28.6, 72.4, 27.7, 73.3, 28.2, 72.8,
  25.3, 75.7, 24.6, 76.4, 25.8, 75.2, 24.2, 76.8, 25.4, 75.6, 24.8, 76.2, 25.7, 75.3, 24.4,
  76.6, 25.5, 75.5, 24.7, 76.3, 25.9, 75.1, 24.1, 76.9, 25.6, 75.4, 24.9, 76.1, 25.2, 75.8,
  21.8, 79.2, 20.9, 80.1, 21.5, 79.5, 20.6, 80.4, 21.2, 79.8, 20.3, 80.7, 21.9, 79.1, 20.7,
  80.3, 21.4, 79.6, 20.8, 80.2, 21.6, 79.4, 20.2, 80.8, 21.7, 79.3, 20.5, 80.5, 21.3, 79.7,
  18.4, 82.6, 17.5, 83.5, 18.9, 82.1, 17.2, 83.8, 18.3, 82.7, 17.8, 83.2, 18.7, 82.3, 17.4,
  83.6, 18.5, 82.5, 17.6, 83.4, 18.8, 82.2, 17.1, 83.9, 18.6, 82.4, 17.7, 83.3, 18.2, 82.8,
  14.9, 86.1, 13.8, 87.2, 14.5, 86.5, 13.4, 87.6, 14.2, 86.8, 13.9, 87.1, 14.7, 86.3, 13.5,
  87.5, 14.3, 86.7, 13.7, 87.3, 14.8, 86.2, 13.2, 87.8, 14.6, 86.4, 13.6, 87.4, 14.4, 86.6,
  11.5, 89.5, 10.8, 90.2, 11.2, 89.8, 10.4, 90.6, 11.8, 89.2, 10.6, 90.4, 11.4, 89.6, 10.9,
  90.1, 11.6, 89.4, 10.5, 90.5, 11.9, 89.1, 10.3, 90.7, 11.3, 89.7, 10.7, 90.3, 11.7, 89.3,
  7.8, 93.2, 6.9, 94.1, 7.5, 93.5, 6.6, 94.4, 7.2, 93.8, 6.3, 94.7, 7.9, 93.1, 6.7, 94.3,
  7.4, 93.6, 6.8, 94.2, 7.6, 93.4, 6.2, 94.8, 7.7, 93.3, 6.5, 94.5, 7.3, 93.7, 6.4, 94.6,
  4.2, 96.8, 3.5, 97.5, 4.7, 96.3, 3.1, 97.9, 4.4, 96.6, 3.8, 97.2, 4.6, 96.4, 3.3, 97.7,
  4.5, 96.5, 3.6, 97.4, 4.8, 96.2, 3.2, 97.8, 4.3, 96.7, 3.9, 97.1, 4.1, 96.9, 3.4, 97.6,
];

const temperatureData = [
  18.2, 19.5, 20.1, 21.3, 19.8, 20.5, 21.7, 22.3, 20.8, 21.5,
  19.6, 20.9, 22.1, 21.8, 20.4, 22.5, 23.1, 21.2, 20.7, 22.8,
  19.9, 21.4, 22.6, 20.3, 21.9, 23.4, 22.9, 21.6, 20.2, 23.2,
  21.1, 22.4, 20.6, 23.5, 22.7, 21.0, 24.1, 23.8, 22.2, 21.3,
  20.5, 23.9, 24.3, 22.0, 21.7, 24.5, 23.6, 22.8, 21.4, 24.8,
];

const signalData = [
  -72.3, -68.5, -71.8, -69.2, -73.5, -67.4, -70.9, -68.8, -72.6, -69.7,
  -71.2, -68.1, -73.8, -69.5, -70.4, -67.9, -72.9, -68.3, -71.5, -69.8,
  -73.2, -67.6, -70.7, -68.9, -72.1, -69.4, -71.8, -68.2, -73.6, -69.1,
  -70.3, -67.8, -72.7, -68.6, -71.4, -69.9, -73.4, -67.5, -70.8, -68.7,
  -72.4, -69.3, -71.9, -68.4, -73.7, -69.6, -70.5, -67.7, -72.8, -68.5,
  -53.2, -51.8, -54.5, -52.3, -53.9, -51.4, -54.1, -52.7, -53.6, -51.9,
  -54.8, -52.1, -53.4, -51.6, -54.3, -52.5, -53.7, -51.3, -54.6, -52.9,
  -53.1, -51.7, -54.4, -52.2, -53.8, -51.5, -54.2, -52.6, -53.5, -51.8,
  -54.9, -52.4, -53.3, -51.2, -54.7, -52.8, -53.9, -51.6, -54.1, -52.3,
  -71.6, -68.9, -72.5, -69.6, -71.1, -68.4, -73.1, -69.2, -70.8, -68.7,
  -72.2, -69.5, -71.7, -68.2, -73.3, -69.8, -70.6, -67.9, -72.8, -68.6,
  -71.4, -69.3, -73.5, -67.7, -70.9, -68.8, -72.4, -69.1, -71.8, -68.3,
  -73.7, -69.7, -70.5, -67.6, -72.6, -68.9, -71.3, -69.4, -73.2, -67.8,
  -70.7, -68.5, -72.1, -69.9, -71.9, -68.1, -73.6, -69.5, -70.4, -67.5,
  -52.8, -51.5, -54.2, -52.6, -53.7, -51.9, -54.5, -52.3, -53.4, -51.7,
  -54.1, -52.8, -53.9, -51.4, -54.6, -52.1, -53.2, -51.8, -54.4, -52.5,
  -53.6, -51.3, -54.8, -52.7, -53.1, -51.6, -54.3, -52.4, -53.8, -51.2,
  -54.7, -52.9, -53.5, -51.5, -54.9, -52.2, -53.3, -51.9, -54.1, -52.6,
  -72.9, -69.2, -71.5, -68.7, -73.4, -69.8, -70.8, -68.4, -72.3, -69.5,
  -71.7, -68.9, -73.1, -69.3, -70.6, -68.1, -72.7, -69.6, -71.2, -68.5,
  -73.6, -69.1, -70.4, -67.9, -72.5, -69.7, -71.9, -68.3, -73.8, -69.4,
  -70.7, -67.7, -72.1, -68.8, -71.4, -69.9, -73.3, -67.6, -70.9, -68.6,
  -72.6, -69.2, -71.8, -68.2, -73.5, -69.5, -70.5, -67.8, -72.8, -68.7,
  -53.6, -51.9, -54.3, -52.5, -53.8, -51.4, -54.7, -52.8, -53.2, -51.7,
  -54.5, -52.3, -53.9, -51.6, -54.1, -52.6, -53.7, -51.3, -54.8, -52.1,
  -53.4, -51.8, -54.2, -52.7, -53.5, -51.5, -54.6, -52.4, -53.1, -51.2,
  -54.4, -52.9, -53.3, -51.9, -54.9, -52.2, -53.8, -51.6, -54.1, -52.5,
  -71.3, -68.8, -72.7, -69.4, -70.9, -68.2, -73.2, -69.7, -71.6, -68.5,
  -72.4, -69.1, -71.8, -68.9, -73.5, -69.5, -70.7, -67.9, -72.9, -68.6,
  -71.2, -69.8, -73.7, -67.7, -70.5, -68.7, -72.2, -69.3, -71.9, -68.4,
];

const velocityData = [
  235.6, 189.3, 267.8, 145.2, 298.5, 201.7, 178.9, 256.3, 134.8, 289.2,
  223.4, 167.5, 245.9, 198.6, 276.3, 156.8, 312.7, 189.4, 234.1, 267.5,
  145.9, 298.2, 212.6, 178.3, 256.8, 198.1, 289.7, 167.4, 245.2, 223.9,
  298.6, 156.3, 312.4, 189.7, 234.5, 267.1, 145.6, 276.9, 212.3, 178.6,
  256.2, 198.8, 289.4, 167.9, 245.7, 223.5, 298.1, 156.7, 312.9, 189.2,
  234.8, 267.6, 145.3, 276.4, 212.9, 178.1, 256.7, 198.4, 289.8, 167.2,
  245.4, 223.8, 298.7, 156.5, 312.2, 189.9, 234.3, 267.3, 145.8, 276.7,
  212.5, 178.8, 256.4, 198.6, 289.5, 167.7, 245.9, 223.2, 298.3, 156.9,
  312.6, 189.5, 234.7, 267.9, 145.5, 276.2, 212.7, 178.4, 256.9, 198.2,
  289.1, 167.5, 245.6, 223.6, 298.8, 156.4, 312.8, 189.8, 234.2, 267.4,
  356.7, 423.5, 389.2, 412.8, 367.9, 445.3, 378.4, 401.6, 434.2, 398.7,
  356.1, 423.9, 389.6, 412.3, 367.4, 445.8, 378.9, 401.2, 434.7, 398.2,
  356.5, 423.2, 389.8, 412.6, 367.7, 445.1, 378.2, 401.8, 434.5, 398.5,
  356.9, 423.6, 389.4, 412.9, 367.2, 445.5, 378.7, 401.4, 434.1, 398.9,
  356.3, 423.8, 389.1, 412.5, 367.6, 445.9, 378.5, 401.9, 434.8, 398.4,
  467.2, 489.7, 456.8, 478.3, 501.6, 445.9, 489.4, 467.8, 478.6, 501.2,
  456.3, 489.9, 467.5, 478.8, 501.8, 445.6, 489.2, 467.9, 478.4, 501.5,
  456.7, 489.5, 467.3, 478.2, 501.4, 445.8, 489.8, 467.6, 478.9, 501.9,
  456.2, 489.3, 467.8, 478.5, 501.3, 445.5, 489.6, 467.4, 478.7, 501.7,
  456.5, 489.1, 467.2, 478.3, 501.1, 445.9, 489.9, 467.9, 478.6, 501.6,
  123.4, 98.7, 156.2, 87.5, 167.8, 112.9, 145.3, 98.1, 134.6, 178.2,
  123.8, 98.3, 156.7, 87.9, 167.3, 112.5, 145.8, 98.6, 134.2, 178.7,
  123.2, 98.9, 156.4, 87.3, 167.6, 112.7, 145.5, 98.4, 134.8, 178.4,
  123.6, 98.5, 156.9, 87.7, 167.1, 112.3, 145.2, 98.8, 134.4, 178.9,
  123.9, 98.2, 156.3, 87.6, 167.8, 112.8, 145.7, 98.2, 134.9, 178.3,
  289.5, 312.8, 267.3, 334.6, 256.9, 301.2, 278.4, 323.7, 289.8, 312.4,
  267.6, 334.2, 256.5, 301.7, 278.9, 323.3, 289.2, 312.9, 267.9, 334.8,
  256.3, 301.4, 278.6, 323.5, 289.7, 312.5, 267.4, 334.4, 256.8, 301.9,
  278.2, 323.9, 289.4, 312.7, 267.7, 334.1, 256.6, 301.5, 278.8, 323.6,
  412.3, 434.8, 389.6, 456.2, 401.7, 423.5, 445.9, 378.4, 412.8, 434.3,
  389.2, 456.7, 401.3, 423.9, 445.5, 378.9, 412.5, 434.6, 389.8, 456.4,
  401.9, 423.2, 445.7, 378.6, 412.7, 434.9, 389.4, 456.1, 401.5, 423.7,
  445.3, 378.8, 412.2, 434.5, 389.9, 456.8, 401.8, 423.4, 445.8, 378.2,
  534.6, 567.3, 512.8, 589.5, 498.2, 556.7, 523.9, 578.4, 534.2, 567.8,
  512.4, 589.1, 498.7, 556.3, 523.5, 578.9, 534.8, 567.5, 512.9, 589.7,
  498.4, 556.9, 523.2, 578.6, 534.5, 567.2, 512.6, 589.3, 498.9, 556.5,
  523.7, 578.2, 534.3, 567.9, 512.3, 589.8, 498.5, 556.8, 523.4, 578.5,
  178.9, 201.5, 156.3, 223.7, 189.4, 212.8, 167.6, 234.2, 178.5, 201.9,
  156.8, 223.3, 189.9, 212.4, 167.2, 234.7, 178.3, 201.6, 156.5, 223.9,
  189.7, 212.9, 167.8, 234.4, 178.7, 201.3, 156.9, 223.5, 189.2, 212.6,
  167.4, 234.8, 178.8, 201.8, 156.4, 223.2, 189.5, 212.3, 167.9, 234.6,
  298.4, 323.7, 278.9, 345.2, 289.6, 312.5, 301.8, 334.9, 298.2, 323.4,
  278.5, 345.7, 289.3, 312.9, 301.4, 334.5, 298.7, 323.8, 278.7, 345.3,
  289.8, 312.6, 301.9, 334.2, 298.5, 323.5, 278.4, 345.9, 289.5, 312.3,
  301.6, 334.7, 298.3, 323.9, 278.8, 345.5, 289.7, 312.8, 301.5, 334.4,
  445.3, 467.8, 423.5, 489.2, 434.9, 456.6, 478.4, 412.7, 445.7, 467.4,
  423.9, 489.7, 434.5, 456.2, 478.9, 412.3, 445.4, 467.9, 423.6, 489.3,
  434.8, 456.7, 478.5, 412.8, 445.9, 467.5, 423.2, 489.8, 434.4, 456.3,
  478.6, 412.5, 445.5, 467.2, 423.8, 489.5, 434.7, 456.9, 478.3, 412.9,
  556.8, 578.4, 534.6, 601.3, 545.9, 567.2, 589.7, 523.5, 556.4, 578.9,
  534.2, 601.8, 545.5, 567.7, 589.3, 523.9, 556.9, 578.5, 534.7, 601.4,
  545.8, 567.3, 589.8, 523.6, 556.5, 578.2, 534.3, 601.9, 545.4, 567.8,
  589.5, 523.2, 556.7, 578.7, 534.8, 601.5, 545.9, 567.4, 589.2, 523.8,
  689.5, 712.3, 667.8, 734.6, 678.9, 701.5, 723.8, 656.4, 689.2, 712.8,
  667.4, 734.2, 678.5, 701.9, 723.4, 656.9, 689.7, 712.5, 667.9, 734.7,
  678.8, 701.6, 723.9, 656.5, 689.4, 712.2, 667.5, 734.3, 678.4, 701.3,
  723.5, 656.8, 689.8, 712.7, 667.2, 734.8, 678.9, 701.8, 723.2, 656.3,
  234.7, 256.3, 212.8, 278.9, 223.5, 245.6, 267.4, 201.9, 234.3, 256.8,
  212.4, 278.5, 223.9, 245.2, 267.9, 201.5, 234.8, 256.4, 212.9, 278.3,
  223.6, 245.7, 267.5, 201.8, 234.5, 256.9, 212.5, 278.7, 223.3, 245.4,
  267.8, 201.6, 234.9, 256.5, 212.3, 278.9, 223.8, 245.9, 267.3, 201.2,
  389.4, 412.7, 367.8, 434.9, 378.5, 401.6, 423.3, 356.9, 389.8, 412.3,
  367.4, 434.5, 378.9, 401.2, 423.8, 356.5, 389.5, 412.8, 367.9, 434.2,
  378.6, 401.7, 423.4, 356.8, 389.9, 412.4, 367.5, 434.7, 378.3, 401.9,
  423.9, 356.4, 389.6, 412.9, 367.3, 434.8, 378.8, 401.5, 423.5, 356.9,
  512.8, 534.5, 489.7, 556.3, 501.9, 523.6, 545.8, 478.4, 512.4, 534.9,
  489.3, 556.8, 501.5, 523.2, 545.4, 478.9, 512.9, 534.6, 489.8, 556.4,
  501.8, 523.7, 545.9, 478.5, 512.5, 534.3, 489.4, 556.9, 501.4, 523.9,
  545.5, 478.2, 512.7, 534.8, 489.9, 556.5, 501.9, 523.5, 545.7, 478.7,
  645.3, 667.9, 623.5, 689.6, 634.7, 656.8, 678.4, 612.9, 645.8, 667.5,
  623.9, 689.2, 634.3, 656.4, 678.9, 612.5, 645.4, 667.8, 623.6, 689.7,
  634.8, 656.9, 678.5, 612.8, 645.9, 667.4, 623.2, 689.3, 634.4, 656.5,
  678.8, 612.4, 645.5, 667.9, 623.8, 689.8, 634.9, 656.3, 678.3, 612.9,
  778.9, 801.4, 756.8, 823.6, 767.5, 789.9, 812.3, 745.7, 778.5, 801.9,
  756.4, 823.2, 767.9, 789.5, 812.8, 745.3, 778.3, 801.5, 756.9, 823.7,
  767.6, 789.8, 812.4, 745.8, 778.8, 801.2, 756.5, 823.3, 767.2, 789.6,
  812.9, 745.4, 778.4, 801.7, 756.3, 823.8, 767.8, 789.3, 812.5, 745.9,
];
      ...
      <section className="mb-12">
        ...
        {componentId === "histogram" && (
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-lg">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
              Histogram uses composable primitives following architecture:
            </p>
            <ul className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                ...
                - Context provider with binning algorithm (default export)
              </li>
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                  Histogram.Container
                </code>{" "}
                - Main wrapper with sizing and border
              </li>
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                  Histogram.Viewport
                </code>{" "}
                - SVG canvas for rendering bars and axes
              </li>
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                  Histogram.Grid
              ...
              <li>
                ...
                - Histogram bars with hover interactions
              </li>
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                  Histogram.Statistics
                </code>{" "}
                - Mean and median overlay lines with labels
              </li>
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                  Histogram.Tooltip
                </code>{" "}
                - Interactive tooltip showing bin range, count, and density
              </li>
              <li>
                <code className="bg-blue-100 dark:bg-blue-900 px-1.5 py-0.5 rounded">
                  Histogram.Empty
            ...
            <div className="mt-4 p-3 bg-blue-100 dark:bg-blue-900/30 rounded border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-xs text-blue-800 dark:text-blue-200">
                Mix and match primitives to create custom histogram layouts. Use{" "}
                <code className="bg-blue-200 dark:bg-blue-800 px-1 py-0.5 rounded text-xs">
                  mode="density"
                </code>{" "}
                for probability density visualization, or add{" "}
                <code className="bg-blue-200 dark:bg-blue-800 px-1 py-0.5 rounded text-xs">
                  showStats
                </code>{" "}
                to display statistical overlays (mean, median, standard deviation).
              </p>
            </div>
          </div>
        )}
              ...
              {componentId === "histogram" && (
                <>
                  ...
                  <tr>
                    ...
                    <td className="p-3 font-mono text-xs">"default"</td>
                    <td className="p-3 text-zinc-600 dark:text-zinc-400">
                      Visual style: "default", "minimal", "scientific", "dashboard"
                    </td>
                  </tr>
                  <tr>
