...
/**
 * Props for GanttChart.Empty component
...
/**
 * Empty state component - displays placeholder when no tasks are scheduled
 */
...
export interface GanttChartControlsProps
  ...
  onZoomOut?: () => void;
  /**
   * Callback when pan left button is clicked
   */
  onPanLeft?: () => void;
  /**
   * Callback when pan right button is clicked
   */
  onPanRight?: () => void;
  /**
...
/**
 * Controls component - provides zoom and pan controls for the Gantt chart timeline
 */
