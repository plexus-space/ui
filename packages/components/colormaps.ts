...
const INFERNO: [number, number, number][] = [
  ...
  [0.10093, 0.050157, 0.125209],
  [0.258234, 0.038571, 0.229339],
  [0.42197, 0.03348, 0.263453],
  [0.582773, 0.093867, 0.22714],
...
const MAGMA: [number, number, number][] = [
  ...
  [0.520222, 0.12157, 0.443329],
  [0.683546, 0.216906, 0.436418],
  [0.833067, 0.339767, 0.39829],
...
const GREENS: [number, number, number][] = [
  ...
  [0.0, 0.427451, 0.172549],
  [0.0, 0.266667, 0.105882],
];
