...
export const registry = {
    ...
    "box-plot": {
        name: "box-plot",
        type: "components:chart",
        description: "Statistical distribution with quartiles, whiskers, and outliers",
    ...
    "coordinate-systems": {
        ...
        type: "components:primitive",
        description: "Universal coordinate transforms (ECI, ECEF, Geodetic, ENU, UTM) with WGS84",
